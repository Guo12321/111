...
class EntityExtractor:
    def __init__(self):
        ...
        self.tfidf_model = joblib.load('model/tfidf_model.m')
        self.nb_model = joblib.load('model/intent_reg_model.m')"""
        self.tfidf_model = joblib.load(self.tfidf_path)
        self.nb_model = joblib.load(self.nb_path)

        data_dir = 'C:/Users/86181/Desktop/QASystemOnMedicalGraph-master/data/'   #data地址
